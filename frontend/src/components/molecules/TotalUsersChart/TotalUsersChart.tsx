...
export interface TotalUsersChartProps extends HTMLAttributes<HTMLDivElement> {
  onStatisticsPeriodChanged?: (value: string) => void;
  data: TotalUsersChartData;
}

const TotalUsersChart: FC<TotalUsersChartProps> = ({
  ...
  return (
    <div className='' {...props}>
      <div className='flex justify-between items-center mb-1'>
        <h3 className='font-semibold'>Amount of users on platform:</h3>
      </div>
